...
const CategoryHeader = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-center py-2">
            ...
            <div className="bg-gray-50 w-full rounded-lg px-3 sm:px-5 py-3 sm:py-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {tips.map((tip, index) => (
                    <div className="flex flex-row gap-2 items-center" key={index}>
                        ...
                        />
                        <p className="text-sm sm:text-base md:text-lg text-gray-500">{tip.tip}</p>
                    </div>
                ))}
            </div>
                    ...
                    >
                        <div className="flex flex-row gap-2 items-center">
                            <img
                                ...
                                className="size-4 sm:size-5 flex-shrink-0"
                            />
                            <p className="text-base sm:text-lg md:text-xl font-semibold">{tip.tip}</p>
                        </div>
